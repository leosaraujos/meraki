<?php
    if($_POST['contato']){
        ...
        if($_POST['nome'] == ''){
            echo '<span class="badge badge-danger">Informe um nome</span><br/>';
            $erro = 1;
        }
        if($_POST['empresa'] == ''){
            echo '<span class="badge badge-danger">Informe o nome da empresa</span>';
            $erro = 1;
        }
        if($_POST['telefone'] == ''){
        ...
        if($_POST['email'] == ''){
            ...
            if($validacao == 0){
                echo '<span class="label label-danger">Informe um email v&aacute;lido</span><br/>';
                $erro = 1;
            }
        }if($_POST['mensagem'] == ''){
            echo '<span class="badge badge-danger">Informe uma mensagem</span><br/>';
            $erro = 1;
        }
        ...
        if($erro == 0){
            ...
            <table width="500px">
                <thead>
                    <tr>
                        <th colspan="2">
                            <img src="http://leoaraujo.com/yodesign/2s-meraki/images/header-email.jpg" alt="2S - Site Meraki" width="500px">
                        </th>
                    </tr>
                    <tr bgcolor="#8bc741">
            ...
            <?
                echo '<div class="success" style="color:#ffffff"><h4>Mensagem enviada com sucesso!</h4></div>';
            } else {
